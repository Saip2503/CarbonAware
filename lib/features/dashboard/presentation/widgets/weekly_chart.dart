...
class WeeklyChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var entry in chartData) {
      totalWeeklyEmissions += entry.value;
      if (entry.value <= dailyGoal && entry.value > 0) {
        goalMetDays++;
      }
    ...
    final semanticsLabel = 'Bar chart showing weekly carbon footprint. Total weekly emissions are ${totalWeeklyEmissions.toStringAsFixed(1)} kg CO2. Your daily limit is ${dailyGoal.toStringAsFixed(1)} kg. You stayed under your daily limit on $goalMetDays out of 7 days.';
